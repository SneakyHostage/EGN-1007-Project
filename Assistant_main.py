...
lat = "28.31830"
lon = "-80.73245"
api_key_weather = "8a918a960300d863d0a9db2bf46ec9ac"
api_key_news = "07e65f1b311c405aaefc45c02c0e9a8d"
debug = 0
if debug ==0:
    import epd7in5b_V2
else:
...
def main():
    ...
    # UPDATED AT
    display.draw_black.text((10, 8), "Updated " + weather.current_time(), fill=0, font=font8)
